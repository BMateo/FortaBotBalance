...
const initializeData = {
  //set the polygon provider to ask the balance of the desireds accounts in the polygon blockchain
...
function provideInitialize(data) {
  return async function initialize() {
    ...
    data.accounts = Object.entries(config.accountBalance).map(([accountName, entry]) => ({
      ...
      alertType: FindingType.Info,
      alertSeverity: FindingSeverity.Info,
    }));
